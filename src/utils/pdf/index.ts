 ...
 * - Student grid (2-column name cards, regular or bold)
...
export type { StudentGridOptions } from './gridGenerator';
export { generateStudentListPDF } from './listGenerator';

// Re-export utilities that may be needed elsewhere
export { formatPhoneForPDF, createGuardianText, createGuardianTable } from './formatters';
